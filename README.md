...
- [Jira-Scrum_Projects_Concepts](#jira-scrum_projects_concepts)
    - [Personal Set Up](#personal-set-up)
  - [Table of contents](#table-of-contents)
- [1. Introducción](#1-introducción)
  - [1.1. Jira](#11-jira)
  - [1.2. Casos de uso para Jira](#12-casos-de-uso-para-jira)
  - [1.3. Utilidades de Jira](#13-utilidades-de-jira)
...
- [2. Conceptos de Scrum](#2-conceptos-de-scrum)
  - [2.1. ¿Por qué utilizar Scrum?](#21-por-qué-utilizar-scrum)
  - [2.2. Artefactos:](#22-artefactos)
  - [2.3. Divison temporal y conceptos clave en proyectos](#23-divison-temporal-y-conceptos-clave-en-proyectos)
  - [2.4. Eventos / Reuniones por Sprint](#24-eventos--reuniones-por-sprint)
  - [2.5. Flujo de Scrum](#25-flujo-de-scrum)
  - [2.6. Principios de Scrum](#26-principios-de-scrum)
  - [2.7. Aspectos de Scrum](#27-aspectos-de-scrum)
  - [2.8. Fases y procesos de Scrum](#28-fases-y-procesos-de-scrum)
- [3. Proyectos con Jira Software](#3-proyectos-con-jira-software)
  - [3.1. Creación del proyecto](#31-creación-del-proyecto)
  - [3.2. Gestión de usuarios, grupos y permisos](#32-gestión-de-usuarios-grupos-y-permisos)
  - [3.3. Opciones de configuración a destacar en un proyecto gestionado por equipo](#33-opciones-de-configuración-a-destacar-en-un-proyecto-gestionado-por-equipo)
  - [3.4 Opciones de configuración a destacar en un proyecto gestionado por empresa (clásico)](#34-opciones-de-configuración-a-destacar-en-un-proyecto-gestionado-por-empresa-clásico)
- [4. El Backlog](#4-el-backlog)
  - [4.1. Tipos de issues en Jira](#41-tipos-de-issues-en-jira)
    - [4.1.1. Epic](#411-epic)
    - [4.1.2. User Story](#412-user-story)
    - [4.1.3. Bug](#413-bug)
    - [4.1.4. Task](#414-task)
    - [4.1.5. Subtarea: Es parte de una issue. Cualquier issue se puede dividir en subtareas](#415-subtarea-es-parte-de-una-issue-cualquier-issue-se-puede-dividir-en-subtareas)
    - [4.1.6. Personalizadas](#416-personalizadas)
  - [4.2. Crear el backlog del producto](#42-crear-el-backlog-del-producto)
  - [4.3. Registrar los criterios de aceptación](#43-registrar-los-criterios-de-aceptación)
    - [4.3.1. Elementos a considerar en criterios de aceptación](#431-elementos-a-considerar-en-criterios-de-aceptación)
  - [4.4. Registrar estimaciones](#44-registrar-estimaciones)
  - [4.5. Ejemplo](#45-ejemplo)
- [5. Definición y ejecuciónd e sprints](#5-definición-y-ejecuciónd-e-sprints)
  - [5.1. Crear un sprint y el backlog del sprint](#51-crear-un-sprint-y-el-backlog-del-sprint)
  - [5.2. Iniciar y finalizar un sprint](#52-iniciar-y-finalizar-un-sprint)
  - [5.3. Configurar un tablero de sprint](#53-configurar-un-tablero-de-sprint)
  - [5.4. Asignar issue al equipo](#54-asignar-issue-al-equipo)
- [6. Crear el RoadMap del Proyecto](#6-crear-el-roadmap-del-proyecto)
  - [6.1. La planificación de lanzamiento o RoadMap](#61-la-planificación-de-lanzamiento-o-roadmap)
  - [6.2. Como crear el RoadMap](#62-como-crear-el-roadmap)
  - [6.3. Como crear un RoadMap avanzando](#63-como-crear-un-roadmap-avanzando)
  - [6.4 Versiones](#64-versiones)
  - [6.5. Componentes](#65-componentes)
- [7. Reportes y filtros](#7-reportes-y-filtros)
  - [7.1. Busquedas y filtros](#71-busquedas-y-filtros)
  - [7.2. Aprender JQL](#72-aprender-jql)
  - [7.3. Revisión y retrospectiva del Sprint](#73-revisión-y-retrospectiva-del-sprint)
    - [7.3.1. Demostración y revisión](#731-demostración-y-revisión)
    - [7.3.2. Retrospectiva del sprint](#732-retrospectiva-del-sprint)
    - [7.3.3. Reportes en proyectos next-gen (gestionados por el equipo)](#733-reportes-en-proyectos-next-gen-gestionados-por-el-equipo)
    - [7.3.4. Reportes en proyectos clasicos (gestionados por la empresa)](#734-reportes-en-proyectos-clasicos-gestionados-por-la-empresa)
- [8. Automatización y Workflow](#8-automatización-y-workflow)
- [9. Productos de Atlassian de interés](#9-productos-de-atlassian-de-interés)
  - [9.1. Confluence](#91-confluence)
  - [9.2. Software testing con Jira + Zephyr](#92-software-testing-con-jira--zephyr)
  - [9.3. Bitbucket](#93-bitbucket)
